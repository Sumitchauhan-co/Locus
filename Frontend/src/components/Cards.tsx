	...
	return (
		<section className="h-fit w-full flex flex-col gap-10">
			<motion.div
				...
				className="text-5xl flex flex-col text-center gap-3"
			>
				<h2 className="text-transparent bg-clip-text bg-gradient-to-t from-neutral-500 to-white p-2">
			...
			<div className="h-fit w-full flex flex-col p-5 gap-10 md:gap-25 mt-15 sm:mt-25">
				{cards.map((card) => (
					...
					>
						...
						>
							<h2 className="w-full text-2xl md:text-3xl text-(--text-pink-color) text-center font-semibold">
								{card.heading}
							</h2>
						...
						<div className={`${card.id === 3 ? 'w-full' : 'md:w-1/2'} w-full`}>
							<div className="w-full flex justify-center items-center">
								<img
									className="md:block hidden aspect-[16:9]"
									src={card.imgSrc}
									alt={card.alt}
									loading="lazy"
									height={700}
